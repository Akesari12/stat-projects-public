...
setwd("C:/Users/Anike/Dropbox/Homework/Fall 2017/Statistical Models Theory and Application/lab1/data")
...
sunlightheight <- redwood_clean %>%
                ...
                ggplot()  + stat_summary_bin(aes(x=Height, y = total_sun),          fun.y                 ="mean", geom="point") + ggtitle("Total Sunlight vs. Node Height") +                     xlab("THeight (m)") + ylab("Total Sunlight (mol/s)") +                                   theme(panel.grid.major = element_blank(), panel.grid.minor =                             element_blank(), panel.background = element_blank())
